(function($) {
 ...
 var dzChartlist = function(){
    ...
    new Chartist.Bar('#stacked-bar-chart', {
        labels: ['Q1', 'Q2'], // Update labels for only two quarters
        series: [
            [800000, 1200000], // First data series for two quarters
            [200000, 400000], // Second data series for two quarters
            [160000, 290000] // Third data series for two quarters
        ]
    }, {
        stackBars: true,
        axisY: {
        ...
        barWidth: 10 // Adjust the width here, decrease from 20 to 10
